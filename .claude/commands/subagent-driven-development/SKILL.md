...
**vs. Executing Plans (batch execution):**
...
2. If subagent asks questions → answer, then let them proceed
...
6. **Dispatch code quality reviewer subagent** - reviews code quality
...
- **executing-plans** - Use for batch execution instead of same-session execution
